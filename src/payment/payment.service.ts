...
export class PaymentService {
  ...
  async fetchAllTransactions() {
    return await this.transactionStatusModel.aggregate([
      {
        $lookup: {
          from: 'transactions', // Collection name in lowercase plural (usually auto-generated by Mongoose)
  ...
  async fetchAndUpdateTransactionStatus(customOrderId: string) {
    ...
    try {
      ...
      // Update the transaction status if found, otherwise create a new one
      const updatedTransactionStatus = await this.transactionStatusModel.findOneAndUpdate(
        { collect_id: collect_id as Types.ObjectId },  // Lookup by collect_id
        {
          collect_id: collect_id as Types.ObjectId,  // Explicitly include collect_id here
          ...updatePayload,  // Spread the rest of the fields
          payment_details: JSON.stringify(data.payment_details), // Ensure payment_details is stringified
        },
